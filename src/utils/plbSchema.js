export const plbSchema = {
  ...
  'Pie Chart': {
    ...
    fields: [
      ...
      { name: 'slice_label_3', label: 'Option 3 Label', type: 'text', default: '' },
      { name: 'slice_value_3', label: 'Option 3 Value', type: 'number', default: 0 },
      { name: 'slice_color_3', label: 'Option 3 Color', type: 'color', default: '#8B5CF6' },
      { name: 'slice_label_4', label: 'Option 4 Label', type: 'text', default: '' },
      { name: 'slice_value_4', label: 'Option 4 Value', type: 'number', default: 0 },
      { name: 'slice_color_4', label: 'Option 4 Color', type: 'color', default: '#3B82F6' },
      { name: 'slice_label_5', label: 'Option 5 Label', type: 'text', default: '' },
      { name: 'slice_value_5', label: 'Option 5 Value', type: 'number', default: 0 },
      { name: 'slice_color_5', label: 'Option 5 Color', type: 'color', default: '#FF6B6B' },
      { name: 'slice_label_6', label: 'Option 6 Label', type: 'text', default: '' },
      { name: 'slice_value_6', label: 'Option 6 Value', type: 'number', default: 0 },
