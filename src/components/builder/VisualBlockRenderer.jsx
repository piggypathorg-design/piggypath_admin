...
const VisualBlockRenderer = ({ block, version, isPreviewMode, progressValue }) => {
  ...
  switch (block.type) {
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center gap-2">
                <img src={xpImg} alt="XP" className="w-10 h-10 mix-blend-multiply" />
    ...
    case 'Coin Reward':
      return (
        <div className="w-full px-6 py-6 flex flex-row items-center justify-center gap-4">
          <img src={coinsImg} alt="Coins" className="w-14 h-14 mix-blend-multiply animate-mascot-bounce" />
    ...
    case 'Gem Reward':
      return (
        <div className="w-full px-6 py-6 flex flex-row items-center justify-center gap-4">
          <img src={gemsImg} alt="Gems" className="w-14 h-14 mix-blend-multiply animate-mascot-float" />
        ...
        <div className="w-full px-2 py-4">
          <div className="w-full mx-auto max-w-[400px] bg-white border-[3px] border-[#18181B] rounded-[8px] shadow-[4px_4px_0_#18181B] py-2 px-2 flex flex-row items-center justify-between gap-1 overflow-hidden">
            ...
            <div className="flex items-center gap-1 shrink flex-1 justify-center">
              <img src={xpImg} alt="XP" className="w-6 h-6 sm:w-8 sm:h-8 shrink-0 mix-blend-multiply" />
              <span className="font-black text-lg sm:text-xl text-[#18181B] truncate">{data.xp_amount ?? 0}</span>
            </div>

            {/* Coins */}
            <div className="flex items-center gap-1 shrink flex-1 justify-center">
              <img src={coinsImg} alt="Coins" className="w-7 h-7 sm:w-9 sm:h-9 shrink-0 mix-blend-multiply" />
              <span className="font-black text-lg sm:text-xl text-[#18181B] truncate">{data.coins_amount ?? 0}</span>
            </div>

            {/* Gems */}
            <div className="flex items-center gap-1 shrink flex-1 justify-center">
              <img src={gemsImg} alt="Gems" className="w-7 h-7 sm:w-9 sm:h-9 shrink-0 mix-blend-multiply" />
    ...
    case 'Reward Icon':
      const renderIcon = () => {
        if (data.icon_type === 'Gold Coin') {
          return <img src={coinsImg} alt="Coins" className="w-14 h-14 mix-blend-multiply animate-mascot-bounce" />;
        } else if (data.icon_type === 'Green Gem') {
          return <img src={gemsImg} alt="Gems" className="w-14 h-14 mix-blend-multiply animate-mascot-float" />;
        } else {
          // XP Sparkle
          return <img src={xpImg} alt="XP" className="w-14 h-14 mix-blend-multiply animate-mascot-pulse" />;
        }
      };
